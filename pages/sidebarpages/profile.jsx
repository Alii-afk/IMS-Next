      ...
      <div className="lg:ml-72 p-8 w-full">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="mb-8">
            ...
            <p className="mt-2 text-gray-600 text-lg">Manage and update your profile details</p>
          </div>
          ...
          <div className="bg-white rounded-2xl shadow-xl p-8 space-y-8 transition-all duration-300 hover:shadow-2xl">
            ...
            <div className="flex flex-col items-center mb-8">
              <div className="relative group">
                <img
                  src={imagePreview || "https://randomuser.me/api/portraits/men/1.jpg"}
                  alt="Profile"
              ...
              <div className="flex justify-between items-center p-4 rounded-xl bg-gray-50 hover:bg-gray-100 transition-all duration-300">
                {isEditing.name ? (
                  ...
                  <div className="flex-1">
                    ...
                    <h3 className="text-xl font-semibold text-gray-800 mt-1">{formData.name}</h3>
                  </div>
                )}
                <div
              ...
              <div className="flex justify-between items-center p-4 rounded-xl bg-gray-50 hover:bg-gray-100 transition-all duration-300">
                {isEditing.email ? (
                  ...
                  <div className="flex-1">
                    ...
                    <h3 className="text-xl font-semibold text-gray-800 mt-1">{formData.email}</h3>
                  </div>
                )}
                <div
                  className="ml-4 p-2 cursor-pointer text-indigo-600 hover:text-indigo-700 transition-all duration-300 rounded-full hover:bg-indigo-50"
                  ...
                  <div className="flex flex-col items-center">
                    ...
                    {imagePreview ? (
                      ...
                      <div className="mt-6 text-center text-gray-400">
                        ...
                        <p className="text-sm mt-1">Upload a new profile picture</p>
                      </div>
                    )}

                    {imagePreview && (
                      <button
                        onClick={() => setIsEditing({ ...isEditing, image: false })}
                        className="mt-6 bg-indigo-600 text-white py-2 px-6 rounded-lg hover:bg-indigo-700 transition-all duration-300 shadow-md hover:shadow-lg"
                      >
                        Save Image
                      </button>
                    )}
            ...
            {/* Save/Cancel Buttons for editable fields */}
            {(isEditing.name || isEditing.email) && (
              <div className="mt-8 flex space-x-4 justify-center">
                <button
                  onClick={() => handleSave(isEditing.name ? "name" : "email")}
                  className="px-8 py-3 bg-indigo-600 text-white font-semibold rounded-lg hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-indigo-600 focus:ring-offset-2 transition-all duration-300 shadow-md hover:shadow-lg"
                >
                  Save Changes
                </button>
                <button
                  onClick={() => setIsEditing({ name: false, email: false })}
                  className="px-8 py-3 bg-gray-100 text-gray-700 font-semibold rounded-lg hover:bg-gray-200 focus:outline-none focus:ring-2 focus:ring-gray-500 focus:ring-offset-2 transition-all duration-300"
                >
                  Cancel
                </button>
              </div>
